...
const displayLeaderboard = el("leaderboard")
...
UI.init = function() {
    ...
    username.onkeydown = function(event){
        ...
        if (username.value !== "") {
            submitScore();
            console.log("unshow the endquest box");
        } else {
            console.log("you submitted an empty username!");
        }
